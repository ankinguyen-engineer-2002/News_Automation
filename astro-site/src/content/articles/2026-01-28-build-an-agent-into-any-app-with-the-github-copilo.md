...
[GitHub Copilot SDK](https://github.com/github/copilot-sdk?utm_source=blog-cli-sdk-repo-cta&utm_medium=blog&utm_campaign=cli-sdk-jan-2026) (now in technical preview) removes that burden. It allows you to take the same Copilot agentic core that powers GitHub Copilot CLI and embed it in any application.

This gives you programmatic access to the same production-tested execution loop that powers [GitHub Copilot CLI](https://github.com/features/copilot/cli?utm_source=blog-announcement-cli-sdk&utm_medium=blog&utm_campaign=cli-sdk-jan-2026). That means instead of wiring your own planner, tool loop, and runtime, you can embed that agentic loop directly into your application and build on top of it for any use case.
...
**The**[**github/copilot-sdk**](https://github.com/github/copilot-sdk?utm_source=blog-cli-sdk-repo-cta&utm_medium=blog&utm_campaign=cli-sdk-jan-2026)**repository includes:**
...
Visit [github/copilot-sdk](https://github.com/github/copilot-sdk?utm_source=blog-cli-sdk-repo-cta&utm_medium=blog&utm_campaign=cli-sdk-jan-2026) to start building.

[![](https://github.blog/wp-content/uploads/2026/01/Screenshot-2026-01-21-at-6.26.15-PM.png)](https://github.blog/wp-content/uploads/2026/01/copilot-silent-click.mp4)
...
**Start building today**! Visit the [SDK repository to get started](https://github.com/github/copilot-sdk?utm_source=blog-cli-sdk-repo-cta&utm_medium=blog&utm_campaign=cli-sdk-jan-2026).
